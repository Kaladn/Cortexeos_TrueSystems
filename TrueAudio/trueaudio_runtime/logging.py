...
from .machine import capture_linux_pipewire_loopback
...
def log_machine_pre_sound_state(
    *,
    ...
    The default capture provider uses the Linux PipeWire/Pulse output monitor. Tests and other
    ...
    provider = capture_provider or capture_linux_pipewire_loopback
