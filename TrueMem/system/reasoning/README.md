...
The reasoning lane is for bridge work that is intentionally outside native TrueMem intake, retrieval, and speech:
...
dataset-specific logic in truemem.engine
...
TrueMem remains the evidence machine. Thinking consumes packets off-path and must not
