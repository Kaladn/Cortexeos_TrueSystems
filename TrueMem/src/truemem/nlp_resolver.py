...
RESOLVER_ID = "truemem_deterministic_nlp_resolver@1"
ABBREVIATIONS = {
    "e.g.",
    "i.e.",
    "mr.",
...
def resolve_answer(question: str, answer_packet: dict[str, Any]) -> dict[str, Any]:
    """Convert locked TrueMem evidence locations into a cited readable answer.
    ...
    locations that TrueMem already admitted into the packet.
    """
    ...
    if not locations:
        return {
            ...
            "citation_source": "truemem_locked_packet",
        }
    ...
    if not cited_sentences:
        return {
            ...
            "resolver": RESOLVER_ID,
            "status": "not_enough_information",
            "text": "TrueMem found locations, but the admitted text could not be converted into a supported answer.",
            "citations": citations,
            "model_used": "none",
            "model_may_search": False,
            "citation_source": "truemem_locked_packet",
...
def _conversation_reply(question: str, locations: list[dict[str, Any]]) -> dict[str, Any] | None:
    ...
    return {
        ...
        "conversation_reply_receipt": {
            "schema": "truemem_conversation_reply_receipt@1",
