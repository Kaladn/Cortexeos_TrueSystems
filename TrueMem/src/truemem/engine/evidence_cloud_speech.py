...
CASE_SCHEMA = "truemem_evidence_cloud_speech_case@0"
TRACE_SCHEMA = "truemem_evidence_cloud_speech_trace@0"
PRETTY_SCHEMA = "truemem_evidence_cloud_speech_pretty_answer@0"
...
def run_evidence_cloud_speech(
    *,
    ...
    This is a report/tool lane. It reads one existing TrueMem query packet,
    ...
    write_json(out / "receipts" / "inputs_receipt.json", {
        "schema": "truemem_evidence_cloud_speech_inputs_receipt@0",
    ...
    run_receipt = {
        "schema": "truemem_evidence_cloud_speech_run_receipt@0",
        "created_at": utc_now(),
        "packet_path": str(packet),
        "output_dir": str(out),
        "retrieval_ran": False,
...
def _compare_artifact_states(before: list[ArtifactState], after: list[ArtifactState]) -> dict[str, Any]:
    ...
    return {
        "schema": "truemem_evidence_cloud_speech_no_mutation_receipt@0",
