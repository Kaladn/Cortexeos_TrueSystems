    ...
    *,
    ...
    if not value.strip():
        return with_protected_notice({
            "schema": "truemem_operator_chat_count_append@1",
            "appended": False,
    ...
    event = with_protected_notice({
        "schema": "truemem_operator_chat_event@1",
        "record_id": record_id,
    ...
    write_json(counts_path, {
        "schema": "truemem_operator_chat_anchor_counts@1",
        "chat_day": day,
        "source": source,
    ...
    write_json(manifest_path, {
        "schema": "truemem_operator_chat_daily_manifest@1",
        "chat_day": day,
