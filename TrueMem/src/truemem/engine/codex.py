...
def stage_codex_sessions(
    ...
    *,
    ...
    """Convert Codex session JSONL files into TrueMem chat-turn markdown."""
    ...
    return with_protected_notice({
        "schema": "truemem_codex_session_stage_receipt@1",
        "created_at": utc_now(),
...
def stage_codex_markdown_export(
    ...
    """Convert a visible Codex Markdown chat export into TrueMem chat-turn markdown."""
    ...
    return with_protected_notice({
        "schema": "truemem_codex_markdown_stage_receipt@1",
        "created_at": utc_now(),
...
def stage_chatgpt_export(
    ...
    *,
    ...
    """Convert ChatGPT data-export conversations JSON into TrueMem chat-turn markdown."""
    ...
    return with_protected_notice({
        "schema": "truemem_chatgpt_export_stage_receipt@1",
        "created_at": utc_now(),
