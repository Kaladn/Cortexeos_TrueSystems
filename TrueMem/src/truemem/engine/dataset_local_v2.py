"""Versioned dataset-local four-byte TrueMem symbol format.

This module is intentionally additive.  The older ``truemem_dataset_6b@1``
...
FORMAT_SCHEMA = "truemem_dataset_local_u32@1"
MANIFEST_SCHEMA = "truemem_dataset_manifest@2"
LEXICON_SCHEMA = "truemem_dataset_lexicon@2"
COUNT_BACKEND = "truemem_dataset_local_u32_counts@1"
SYMBOL_SYSTEM = "truemem_dataset_local_sequential_u32@1"
SYMBOL_BYTES = 4
SYMBOL_MIN = 1
SYMBOL_MAX = (1 << 32) - 1
LEGACY_FORMATS = ("truemem_dataset_6b@1", "workspace_monotonic_integer_6b", "deterministic_anchor_hash_6b")
...
def validate_resolution(lexicon: dict, artifacts: dict[str, bytes]) -> dict:
    ...
    return {
        "schema": "truemem_dataset_local_u32_validation@1",
