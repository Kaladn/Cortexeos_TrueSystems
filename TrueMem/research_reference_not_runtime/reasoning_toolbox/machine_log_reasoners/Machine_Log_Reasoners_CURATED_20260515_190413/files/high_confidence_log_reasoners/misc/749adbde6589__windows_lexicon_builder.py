"""
Windows 11 Optimized Production Lexicon Builder
Handles files, directories, compressed files, and XML processing

Features:
- Windows 11 path handling and file operations
- File OR directory corpus input
- Gzipped file support
- XML/HTML parsing
- Fixed NLTK data downloads
- Windows Terminal progress display
"""
...
class WindowsLexiconBuilder:
    """
    Windows 11 optimized production lexicon builder
    Handles files, directories, and various formats
    """
    
    def __init__(self):
        self.setup_nltk_complete()
    ...
    def setup_nltk_complete(self):
        """Download ALL required NLTK data for Windows"""
        print("📦 Setting up NLTK data for Windows...")
        ...
        for data in required_data:
            try:
                ...
                elif data == 'averaged_perceptron_tagger_eng':
    ...
    def extract_text_from_xml(self, xml_content: str) -> str:
        ...
        except ET.XMLParser.XMLSyntaxError:
            # If XML parsing fails, extract text using regex
    ...
    def process_single_file(self, file_path: Path) -> Dict[str, Set[str]]:
        ...
        if file_path.suffix.lower() in {'.xml', '.html', '.htm'} or file_path.name.lower().endswith('.xml.gz'):
    ...
    def process_text_content(self, content: str) -> Dict[str, Set[str]]:
        """Process text content and extract word variations"""
    ...
    def get_adjective_variations(self, word: str) -> Set[str]:
        ...
        # Comparative and superlative for short adjectives
    ...
    def classify_domain(self, word: str) -> str:
        ...
        # Proper nouns (would need original case to detect)
    ...
    def run(self):
        ...
        print("🚀 WINDOWS 11 PRODUCTION LEXICON BUILDER")
        print("=" * 50)
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="Windows 11 Production Lexicon Builder")
