...
from core.clearbox_network.router import router as _r_network  # noqa: E402
from core.clearbox_node.api.router import router as _r_nodes  # noqa: E402
...
def create_app(state: BridgeState) -> FastAPI:
    ...
    app.include_router(_r_nodes)
    app.include_router(_r_network)
