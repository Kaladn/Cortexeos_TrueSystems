...
class CompuCogOrganism:
    ...
    def initialize(self) -> bool:
        ...
        # Step 2: Initialize Forge Memory (BinaryLog + StringDictionary)
        print(f"  [2/5] Forge Memory ({self.forge_dir})...", end=" ")
        self.forge_dir.mkdir(parents=True, exist_ok=True)
        
        from forge_memory.core.string_dictionary import StringDictionary
        string_dict = StringDictionary(str(self.forge_dir))
