...
class BM25Index:
    ...
    def build(
        ...
        # Extract terms for BM25 (simple whitespace + lowercase)
        tokenized = [self._extract_terms(t) for t in chunk_texts]
    ...
    def query(
        ...
        tokens = self._extract_terms(query_text)
        if not tokens:
            return []
    ...
    def _extract_terms(text: str) -> List[str]:
        """Extract terms — delegates to lakespeak.text.normalize."""
