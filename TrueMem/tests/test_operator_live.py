...
from truemem.operator_live import run_live_shell
from truemem.operator_shell import OperatorShell
...
def test_operator_shell_once_menu_stays_plain_behavior():
    ...
    assert "TrueMem CLI Cockpit" in str(result["message"])
...
def test_read_system_metrics_is_read_only_packet():
    ...
    assert metrics["schema"] == "truemem_system_metrics@1"
