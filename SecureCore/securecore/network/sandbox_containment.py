...
def execute_sandboxed_containment(
    *,
    ...
    trap = {
        "schema_version": 1,
        "kind": "securecore_sandbox_trap_receipt",
        "created_at_utc": now,
    ...
    block = {
        "schema_version": 1,
        "kind": "securecore_temporary_block_receipt",
    ...
    release = {
        "schema_version": 1,
        "kind": "securecore_release_receipt",
        "created_at_utc": utc_now(),
        "remote_ip": normalized_ip,
    ...
    report_request = {
        "schema_version": 1,
        "kind": "securecore_central_writer_forensics_request",
        "created_at_utc": utc_now(),
        "title": "SecureCore Temporary Containment Forensics",
        "facts": [
    ...
    review = {
        "schema_version": 1,
        "kind": "securecore_human_security_review_required",
        "created_at_utc": utc_now(),
...
def _default_inert_payload() -> dict[str, Any]:
    raw = b"SECURECORE-INERT-GARBLE-NOT-EXECUTABLE\x00\xff\x10garbled-garble"
    return {
        "bytes_b64": base64.b64encode(raw).decode("ascii"),
        "executable": False,
        "scope": "securecore_local_sandbox_only",
...
def _validate_inert_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    cleaned["scope"] = "securecore_local_sandbox_only"
