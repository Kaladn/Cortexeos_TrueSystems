...
def build_writer_request(
    *,
    ...
    return {
        ...
        "report_format": "securecore_facts_report_v1",
...
def validate_writer_request(request: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(request, "report_format", "securecore_facts_report_v1")
...
def build_facts_report(
    *,
    ...
    return {
        "schema_version": 1,
        "kind": "securecore_facts_report",
        "format": "securecore_facts_report_v1",
        "report_id": report_id,
        "created_at_utc": utc_now(),
        "title": title,
        "severity": severity,
...
def validate_facts_report(report: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(report, "kind", "securecore_facts_report")
    _require(report, "format", "securecore_facts_report_v1")
...
def build_legal_ip_trace_report(
    *,
    ...
    report = {
        "schema_version": 1,
        "kind": "securecore_legal_ip_trace_report",
        "format": "securecore_legal_ip_trace_report_v1",
        "report_id": report_id,
        "created_at_utc": utc_now(),
        "title": title,
        "severity": severity,
...
def validate_legal_ip_trace_report(report: dict[str, Any]) -> dict[str, Any]:
    _require(report, "schema_version", 1)
    _require(report, "kind", "securecore_legal_ip_trace_report")
    _require(report, "format", "securecore_legal_ip_trace_report_v1")
