...
def bootstrap_status():
    ...
    return jsonify({
        ...
        "bootstrap_command": "SECURECORE_ADMIN_USER=<user> SECURECORE_ADMIN_PASS=<pass> python securecore\\cli\\seed_admin.py",
        "reset_command": "SECURECORE_ADMIN_RESET=true SECURECORE_ADMIN_USER=<user> SECURECORE_ADMIN_PASS=<pass> python securecore\\cli\\seed_admin.py",
    })
