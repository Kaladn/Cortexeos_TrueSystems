"""SecureCore internal self-audit logger.

This logger is not part of the normal sensor/logging lane. It writes independent
receipts that let the operator verify SecureCore itself: watchers, runners,
...
class InternalSelfLogger:
    """Write independent SecureCore self-audit receipts."""
...
def build_self_audit_receipt(
    *,
    ...
    receipt = {
        "schema_version": 1,
        "kind": "securecore_internal_self_audit_receipt",
        "receipt_id": "",
...
def validate_self_audit_receipt(receipt: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(receipt, "kind", "securecore_internal_self_audit_receipt")
...
def build_system_trust_receipt(
    *,
    ...
    receipt = {
        "schema_version": 1,
        "kind": "securecore_system_trust_receipt",
        "receipt_id": "",
...
def validate_system_trust_receipt(receipt: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(receipt, "schema_version", 1)
    _require(receipt, "kind", "securecore_system_trust_receipt")
