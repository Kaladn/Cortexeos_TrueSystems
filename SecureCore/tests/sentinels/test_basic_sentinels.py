...
from securecore.forge.sharded import ShardedForgeWriter
from securecore.sentinels.forge_verify import run as run_forge_verify
from securecore.sentinels.fusion_verify import run as run_fusion_verify
from securecore.sentinels.system_trust import run as run_system_trust
...
class BasicSentinelTests(unittest.TestCase):
    ...
    def test_system_trust_sentinel_writes_trust_receipt(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(saved["kind"], "securecore_system_trust_receipt")
