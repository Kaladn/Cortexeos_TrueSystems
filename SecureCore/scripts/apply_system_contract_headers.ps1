<#
CONTRACT: SecureCore/CortexEvolved authored system utility
Owner: Lee Mercey
Watermark: CortexEvolved | Lee Mercey | Codex contributor
Copyright: Copyright (c) 2026 Lee Mercey. All rights reserved.
Role: Operator-run contract header utility for active SecureCore system files.
...
$Marker = 'CONTRACT: SecureCore/CortexEvolved authored system file'
$UtilityMarker = 'CONTRACT: SecureCore/CortexEvolved authored system utility'
...
function Get-HeaderForFile {
    ...
    $common = @(
        'CONTRACT: SecureCore/CortexEvolved authored system file',
        'Owner: Lee Mercey',
        'Watermark: CortexEvolved | Lee Mercey | Codex contributor',
        'Copyright: Copyright (c) 2026 Lee Mercey. All rights reserved.',
