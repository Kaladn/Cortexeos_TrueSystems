...
class Substrate:
    ...
    def __init__(self, data_dir: str):
        ...
        self._forge_strict = os.getenv("TRUECORE_FORGE_STRICT", "false").lower() == "true"

        if os.getenv("TRUECORE_FORGE_ENABLED", "false").lower() == "true":
            forge_root = os.getenv("TRUECORE_FORGE_DIR", "")
            if forge_root:
    ...
    def append(
        ...
        if self._permission_gate is not None:
            ...
            if effective_token is None:
                from truecore.permissions.gate import PermissionDenied
