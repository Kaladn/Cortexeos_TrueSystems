"""AnchorWorks route-pressure adapter for TrueCore.
...
from truecore.central.contracts import build_model_writer_report_request


class RouteTapError(ValueError):
    """Raised when an external route object violates TrueCore boundaries."""
...
def build_writer_request_from_sentence_plan(
    ...
    *,
    ...
    _require(plan, "kind", "truecore_sentence_plan")
