...
Usage:
    python -m truecore.cli.cell_report                   # list all cells
    python -m truecore.cli.cell_report --cell <id>       # full evidence bundle
    python -m truecore.cli.cell_report --verify <name>   # verify substrate chain
    python -m truecore.cli.cell_report --dashboard       # substrate + agent stats
    python -m truecore.cli.cell_report --audit           # full chain audit
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="TrueCore Forensic Reporter")
