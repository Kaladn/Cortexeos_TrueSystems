...
def build_agent_handoff_packet(
    *,
    ...
    packet = {
        "schema_version": 1,
        "kind": "truecore_agent_handoff_packet",
...
def validate_agent_handoff_packet(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(packet, "kind", "truecore_agent_handoff_packet")
...
def build_agent_handoff_reply(
    *,
    ...
    reply = {
        "schema_version": 1,
        "kind": "truecore_agent_handoff_reply",
        "created_at_utc": utc_now(),
        "reply_id": reply_id,
        "handoff_id": handoff_id,
        "from_agent": from_agent,
...
def validate_agent_handoff_reply(
    ...
    _require(reply, "kind", "truecore_agent_handoff_reply")
