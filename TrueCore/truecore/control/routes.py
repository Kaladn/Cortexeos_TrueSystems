...
def dashboard():
    ...
    from truecore.control.shun import get_shun_list, get_shun_count
...
@role_required("admin")
def manual_shun():
    from truecore.control.shun import shun_ip as do_shun
...
@role_required("admin")
def manual_unshun():
    from truecore.control.shun import unshun_ip as do_unshun
    data = request.get_json(silent=True) or {}
    ip = data.get("ip", "").strip()
...
@role_required("admin")
def purge_shuns():
    from truecore.control.shun import purge_all_shun_rules
