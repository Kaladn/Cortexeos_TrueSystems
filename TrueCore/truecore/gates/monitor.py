"""TrueCore gate monitor snapshot.

TrueCore gates the Cortex stack and monitors the host environment. This module
...
def build_gate_monitor_snapshot() -> dict[str, Any]:
    ...
    return {
        "schema_version": 1,
        "kind": "truecore_gate_monitor",
        "authority_scope": "cortex_stack_gate_host_monitor",
        "kernel_firewall_claimed": False,
        "law": "TrueCore gates stack authority and monitors host edges; it does not claim kernel-level interception.",
