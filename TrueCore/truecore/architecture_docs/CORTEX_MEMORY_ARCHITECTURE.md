...
title: AnchorWorks TrueCore TrueVision Memory Architecture
when_to_use: Use when discussing chat memory, L1-L4 memory layers, TrueMem/SC/TV memory boundaries, ledger versus memory, promotion, counts, OpenAI memory limits, or what happens after chat.
---

# AnchorWorks / TrueCore Memory Architecture vNext
...
## TrueCore Relationship

TrueCore governs memory movement.
...
TrueCore is the authority path.
...
TrueMem/count memory consulted or not consulted
...
TrueMem memory/counts = promoted durable memory
...
TrueMem promotes/counts durable memory
