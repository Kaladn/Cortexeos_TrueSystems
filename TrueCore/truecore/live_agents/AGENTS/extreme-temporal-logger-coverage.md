...
- TrueCore repo root.
- `truecore/live_agents`.
- `truecore/agents`.
- `truecore/substrates`.
- `truecore/data/runtime`.
- `truecore/data/runtime/control_bus`.
- `truecore/data/runtime/evidence`.
- `truecore/data/runtime/logs`.
- `truecore/help/content`.
- `truecore/permissions`.
- `tests`.
- `.git`.
- `.github`.
...
- TrueCore CLI command launched.
- TrueCore agent runner launched.
...
- TrueCore service registration changed.
...
- Task launched TrueCore scripts.
...
## TrueCore Agent Movement

Log these TrueCore-specific events:
...
- Any TrueCore live-agent contract or runner mutation.
- Any evidence deletion or modification.
- Any process from temp path touching TrueCore or evidence.
...
- Expected TrueCore test execution.
...
- File system watcher for TrueCore repo and security-sensitive host paths.
...
- Git status/log watcher for TrueCore repo.
- TrueCore command bus hook.
- TrueCore permission gate hook.
- TrueCore agent runner hook.
- TrueCore evidence writer hook.
...
- Changes TrueCore agent catalogs.
