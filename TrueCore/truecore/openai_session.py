"""Ephemeral OpenAI API key sessions for TrueCore chat.
...
DEFAULT_OPENAI_MODEL = os.environ.get("TRUECORE_OPENAI_DEFAULT_MODEL", "gpt-4.1-mini")
...
class OpenAIKeyVault:
    """Small in-memory key vault keyed by authenticated TrueCore identity."""
