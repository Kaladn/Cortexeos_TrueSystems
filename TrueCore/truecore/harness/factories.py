"""Draft factory blueprints for TrueCore creator surfaces."""
    ...
    return [
        {
            ...
            "allowed_languages": ["python", "rust", "cpp"],
            "activation_gate": "receipt path configured, operator approval, and observed operation through the authorized route",
        ...
        },
        {
            ...
            "allowed_languages": ["python", "rust", "cpp", "typescript", "javascript"],
            "activation_gate": "policy allows capability and the authorized production route produces an observed effect",
            "forbidden": ["prompt-only worker", "direct policy bypass", "unbounded runtime"],
        },
        {
            "kind": "agent",
            "title": "Agent Creation Draft",
            "purpose": "Create a coded agent manifest around an existing admitted capability.",
            "required_fields": [
                "agent_id",
                "runtime_language",
                "entrypoint",
