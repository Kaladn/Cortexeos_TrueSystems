"""B70-resident relationship qualification for the HotpotQA benchmark."""
...
from .hotpotqa_evidence_speech import relationship_demands
...
class XpuRelationshipIndex:
    ...
    def qualify_and_select(self, question: str, *, maximum_pool: int = 160) -> dict[str, Any]:
        from truemem.engine.anchors import anchor_kind, anchorize
        ...
        qualified = (relation_counts > 0) | (parent_counts > 0)
        ...
        pool = torch.unique(torch.cat((relation_pool, parent_pool)), sorted=True)
        ...
        pair_order = _lexicographic_order([
            -pair_coverage,
            -pair_bridge_weight,
            -pair_relations,
            -pair_parents,
        ...
        _assert_xpu(relation_counts, parent_counts, coverage, qualified_ids, pool, presence, bridge_count, bridge_frequency_corrected, pair_order, selected, bridge_ids)
        torch.xpu.synchronize()
        return {
