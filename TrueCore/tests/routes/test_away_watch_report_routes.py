...
class AwayWatchReportRouteTests(unittest.TestCase):
    def setUp(self):
        ...
        self.report_path.write_text(
            json.dumps(
                {
                    "kind": "truecore_away_watch_start_snapshot",
        ...
        self.old_root = os.environ.get("TRUECORE_AWAY_WATCH_ROOT")
        os.environ["TRUECORE_AWAY_WATCH_ROOT"] = str(self.runtime_root)
    ...
    def _restore_env(self):
        if self.old_root is None:
            os.environ.pop("TRUECORE_AWAY_WATCH_ROOT", None)
        else:
            os.environ["TRUECORE_AWAY_WATCH_ROOT"] = self.old_root
    ...
    def test_report_read_returns_text_without_mutation(self):
        ...
        self.assertEqual(payload["parsed"]["kind"], "truecore_away_watch_start_snapshot")
