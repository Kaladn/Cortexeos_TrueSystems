...
class HIDSubstrateTests(unittest.TestCase):
    def test_recent_attestation_detects_local_activity(self):
        ...
        try:
            ...
            hid.record_session_state(session_locked=False, idle_seconds=4, foreground_app="TrueCore")
            hid.record_keyboard_activity(key_event_count=8, typing_variance=0.23, active_window="TrueCore")
            ...
            self.assertEqual(attestation["foreground_app"], "TrueCore")
        finally:
