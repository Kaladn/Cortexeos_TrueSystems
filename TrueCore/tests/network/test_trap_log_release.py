...
from truecore.network.containment import ContainmentContractError, build_trap_log_release_plan
...
class TrapLogReleasePlanTests(unittest.TestCase):
    def test_plan_requires_trap_log_release_without_permanent_action(self):
        ...
        self.assertEqual(plan["kind"], "truecore_trap_log_release_plan")
