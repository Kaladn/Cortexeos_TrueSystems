...
from truecore.central.contracts import validate_model_writer_report_request
from truecore.route_tap.anchorworks import (
    RouteTapError,
    build_sentence_plan,
...
class AnchorWorksRouteTapTests(unittest.TestCase):
    def test_route_tap_code_does_not_import_or_write_anchorworks(self):
        source = Path("truecore/route_tap/anchorworks.py").read_text(encoding="utf-8")
    ...
    def test_builds_sentence_plan_from_admitted_trace_not_raw_speech(self):
        ...
        self.assertEqual(plan["kind"], "truecore_sentence_plan")
    ...
    def test_converts_sentence_plan_to_facts_only_writer_request(self):
        ...
        request = build_writer_request_from_sentence_plan(
            ...
            requested_by_model="truecore.route_tap.anchorworks",
            severity="info",
        )
