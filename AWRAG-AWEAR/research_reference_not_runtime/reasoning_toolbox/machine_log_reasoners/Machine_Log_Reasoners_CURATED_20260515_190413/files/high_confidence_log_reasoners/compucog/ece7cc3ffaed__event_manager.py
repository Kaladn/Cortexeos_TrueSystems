...
class EventManager:
    ...
    def __init__(
        ...
        # Capsule cache (optional optimization)
        self.capsule_cache: Dict[str, Capsule] = {}
    ...
    def record_event(
        ...
        # Step 5: Maintain global timeline (sorted by timestamp)
    ...
    def print_stats(self) -> None:
        ...
        if stats['stream_breakdown']:
            ...
            for source_id, count in stats['stream_breakdown'].items():
                print(f"    {source_id}: {count} events")
