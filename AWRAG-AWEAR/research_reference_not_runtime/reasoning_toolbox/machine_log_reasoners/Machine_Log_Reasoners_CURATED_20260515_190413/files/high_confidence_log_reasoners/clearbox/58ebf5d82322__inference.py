...
GROUNDED_LAKESPEAK_UNAVAILABLE = "Grounded retrieval unavailable: LakeSpeak is unavailable."
...
class InferenceService:
    ...
    async def call_grounded(
        ...
        t0 = time.time()
        try:
            engine = self._lakespeak_service.get_engine()
            ...
            return GROUNDED_LAKESPEAK_UNAVAILABLE, {
                "error": "not_available",
                "abstained": True,
                "citations": 0,
            }, int((time.time() - t0) * 1000)
