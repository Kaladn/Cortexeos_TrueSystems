...
from awrag.engine.answer_reasoning_reverse_walk import run_answer_reasoning_reverse_walk
...
def _build_reverse_walk_dataset(runtime: Path, dataset_id: str) -> None:
    ...
    from awrag.engine.base import dataset_paths
...
def test_blind_reverse_walk_builds_topk_tree_without_mutation(tmp_path: Path) -> None:
    ...
    assert result["schema"] == "awrag_answer_reasoning_reverse_walk_run@0"
    ...
    assert trace["reverse_topK_tree"][0]["candidate"]["citation"] == "[AWCIT-1B]"
