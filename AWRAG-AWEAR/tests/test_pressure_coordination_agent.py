...
from awrag.agents.pressure_coordination import run_pressure_coordination_audit
...
def test_pressure_coordination_writes_real_reaper_and_combined_lanes(tmp_path: Path) -> None:
    ...
    _write_trace(
        ...
        [
            {
                "schema": "awrag_answer_reasoning_reverse_walk_trace@0",
                "claim_id": "q1",
    ...
    assert result["schema"] == "awrag_pressure_coordination_audit_run@0"
