...
from awrag.engine.packet_speech import build_packet_speech_record


def test_packet_speech_includes_speech_output_trellis_receipt(tmp_path: Path) -> None:
    packet = {
        "question": "how does AW use counts citations and speech",
        "question_anchors": ["aw", "count", "citation", "speech"],
        "model_used": "none",
        "answer_packet": {
            "qualification": {
            ...
            "locations": [
                {
                    ...
                    "matched_anchors": ["aw", "count", "citation", "speech"],
        ...
        "final_answer": {"status": "answered_from_awrag_locations", "model_used": "none"},
    }
