...
from awrag.engine.evidence_cloud_speech import run_evidence_cloud_speech
...
def test_evidence_cloud_speech_tightens_inside_packet_cloud(tmp_path: Path) -> None:
    ...
    assert result["schema"] == "awrag_evidence_cloud_speech_run@0"
    ...
    assert result["citations"][0]["citation"] == "[AWCIT-strong]"
    ...
    assert trace["final_result"]["winner"]["citation"] == "[AWCIT-strong]"
