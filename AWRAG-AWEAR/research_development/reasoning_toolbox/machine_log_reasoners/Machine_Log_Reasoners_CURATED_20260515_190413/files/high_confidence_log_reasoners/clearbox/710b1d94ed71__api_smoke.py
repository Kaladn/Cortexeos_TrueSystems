...
SAFE_PAYLOADS: Dict[str, dict] = {
    ...
    "/api/wolf/analyze": {"text": "smoke test claim"},
}
...
FALLBACK_ROUTES = [
    ...
    {"path": "/api/wolf/status",        "method": "GET",  "has_body": False},
    {"path": "/api/wolf/verdicts/counts","method": "GET", "has_body": False},
    {"path": "/api/wolf/verdicts/recent?limit=5", "method": "GET", "has_body": False},
    {"path": "/api/wolf/modules",       "method": "GET",  "has_body": False},
    {"path": "/api/wolf/snapshot",      "method": "GET",  "has_body": False},
