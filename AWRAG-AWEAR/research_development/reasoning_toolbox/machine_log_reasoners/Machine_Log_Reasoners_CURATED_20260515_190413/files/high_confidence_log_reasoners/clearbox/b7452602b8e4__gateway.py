...
from security.data_paths import (
    ...
    LAKESPEAK_EVAL_DIR,
    WOLF_ENGINE_INDEX_DIR,
    WOLF_ENGINE_EVENTS_DIR,
    WOLF_ENGINE_EVAL_DIR,
    IDEAS_DIR,
)
...
class WriteZone(enum.Enum):
    ...
    # ── Wolf Engine zones ─────────────────────────────────────
    WOLF_ENGINE_INDEX  = "wolf_engine_index"    # Symbol indexes
    WOLF_ENGINE_EVENTS = "wolf_engine_events"   # Analysis event JSONL
    WOLF_ENGINE_EVAL   = "wolf_engine_eval"     # Evaluation reports
    # ── Memory zone ─────────────────────────────────────────
...
_CALLER_PERMISSIONS: dict[str, set[WriteZone]] = {
    ...
    "system": {
        ...
        WriteZone.WOLF_ENGINE_INDEX,
        WriteZone.WOLF_ENGINE_EVENTS,
        WriteZone.WOLF_ENGINE_EVAL,
    },
    "human": {
        WriteZone.ARTIFACTS,
        WriteZone.IDEAS,
...
def _zone_root(zone: WriteZone) -> Path:
    ...
    _map = {
        ...
        WriteZone.WOLF_ENGINE_INDEX:   WOLF_ENGINE_INDEX_DIR,
        WriteZone.WOLF_ENGINE_EVENTS:  WOLF_ENGINE_EVENTS_DIR,
        WriteZone.WOLF_ENGINE_EVAL:    WOLF_ENGINE_EVAL_DIR,
