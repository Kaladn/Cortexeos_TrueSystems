...
class ChunkRef:
    ...
    corpus_id: str = ""             # Named corpus / folder inside the lake
    ...
    citations: Optional[List] = None  # Resolved external citations (from citation_extractor)
...
class AnchorRecord:
    ...
    Anchors are tokens that exist in the Clearbox lexicon,
...
class IngestReceipt:
    ...
    anchor_count: int = 0
    relation_count: int = 0
    citation_style: str = "none"                # "numeric" | "author_date" | "hyperlink" | "footnote" | "none"
    lexicon_version: str = ""
    created_at_utc: str = ""
