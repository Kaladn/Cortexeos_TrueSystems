"""Help System API Router -- FastAPI endpoints.
...
from core.help_system.api.models import (
    HelpContentResponse,
    HelpIdsResponse,
    HelpSearchResponse,
    HelpStatusResponse,
...
def get_engine():
    ...
    if _engine is None:
        with _engine_lock:
            if _engine is None:
                from core.help_system.core.engine import HelpSystemEngine
...
def _version() -> str:
    try:
        from core.help_system import VERSION
        return VERSION
