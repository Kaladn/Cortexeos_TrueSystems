...
Usage (on any machine):
    python -m clearbox_node                           # allowlist only
    python -m clearbox_node --allow-full              # also allows full-system reads
    python -m clearbox_node --port 5060 --host 0.0.0.0
    python -m clearbox_node --generate-pairing-key    # regenerate key
    python -m clearbox_node --print-pairing-key       # show existing key
    python -m clearbox_node --no-discovery            # disable mDNS
"""
...
from clearbox_node.core.identity import get_hostname, get_machine_id
from clearbox_node.core.caps import get_local_caps, get_telemetry
from clearbox_node.core.fs_access import (
    AccessMode,
    FileAccessState,
...
from clearbox_node.core.hmac_auth import (
    NonceStore,
