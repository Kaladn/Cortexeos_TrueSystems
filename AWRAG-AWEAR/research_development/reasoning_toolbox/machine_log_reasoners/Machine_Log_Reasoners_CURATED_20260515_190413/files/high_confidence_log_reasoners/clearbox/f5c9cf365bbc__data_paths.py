...
Data root resolution order:
  ...
  3) Fallback: D:\\Clearbox AI Data Root
...
def _resolve_data_root() -> Path:
    ...
    if saved is not None and _is_usable_root(saved):
        return saved
    for candidate in (PREFERRED_WINDOWS_DATA_ROOT, LEGACY_WINDOWS_DATA_ROOT, Path.home() / "ClearboxAI"):
        if _is_usable_root(candidate):
            return candidate
...
DATA_CITATIONS_BIN_DIR     = CLEARBOX_ROOT / "data" / "citations" / "binary"
CHAT_NOTES_DIR             = CLEARBOX_ROOT / "data" / "notes"
CHAT_MAPS_DIR              = CLEARBOX_ROOT / "data" / "maps"
CHAT_MEMORY_DIR            = CLEARBOX_ROOT / "data" / "memory"
STRUCTURAL_MEMORY_DIR      = CHAT_MEMORY_DIR / "structural"
ANCHOR_OBSERVATIONS_DIR    = STRUCTURAL_MEMORY_DIR / "anchor_observations"
RELATION_OBSERVATIONS_DIR  = STRUCTURAL_MEMORY_DIR / "relation_observations"
STRUCTURAL_LIFECYCLE_DIR   = STRUCTURAL_MEMORY_DIR / "lifecycle"
STRUCTURAL_VIEWS_DIR       = STRUCTURAL_MEMORY_DIR / "views"
STRUCTURAL_VIEWS_DB_PATH   = STRUCTURAL_VIEWS_DIR / "structural_memory.sqlite3"
...
# ── Evidence (cumulative 6-1-6 count store) ────────────────────
EVIDENCE_DIR         = CLEARBOX_ROOT / "data" / "evidence"
...
# ── Genesis ───────────────────────────────────────────────────
GENESIS_INDEX_DIR = CLEARBOX_ROOT / "data" / "indexes" / "genesis"

# ── Reasoning ───────────────────────────────────────────────────
REASONING_CACHE_DIR = CLEARBOX_ROOT / "data" / "indexes" / "reasoning"
...
TOOL_CREATION_DIR       = CLEARBOX_ROOT / "data" / "tool creation"
TOOL_CREATION_LEDGER_DIR = TOOL_CREATION_DIR / "ledger"
TOOL_CREATION_SESSIONS_DIR = TOOL_CREATION_DIR / "sessions"
TOOL_CREATION_DRAFTS_DIR = TOOL_CREATION_DIR / "drafts"
TOOL_CREATION_TOOLS_DIR = TOOL_CREATION_DIR / "tools"
TOOL_CREATION_TESTS_DIR = TOOL_CREATION_DIR / "tests"
...
for _d in [
    ...
    CHAT_CITATIONS_DIR, DATA_CITATIONS_BIN_DIR, CHAT_NOTES_DIR, CHAT_MAPS_DIR,
    CHAT_MEMORY_DIR, STRUCTURAL_MEMORY_DIR, ANCHOR_OBSERVATIONS_DIR,
    RELATION_OBSERVATIONS_DIR, STRUCTURAL_LIFECYCLE_DIR, STRUCTURAL_VIEWS_DIR,
    CHAT_ARCHIVE_DIR,
    ...
    TOOL_CREATION_DIR, TOOL_CREATION_LEDGER_DIR, TOOL_CREATION_SESSIONS_DIR,
    TOOL_CREATION_DRAFTS_DIR, TOOL_CREATION_TOOLS_DIR, TOOL_CREATION_TESTS_DIR,
]:
    try:
