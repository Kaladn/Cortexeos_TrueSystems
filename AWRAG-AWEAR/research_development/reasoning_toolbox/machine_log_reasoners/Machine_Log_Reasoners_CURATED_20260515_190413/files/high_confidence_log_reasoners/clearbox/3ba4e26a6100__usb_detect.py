"""USB device detection for Clearbox AI mobile node pairing.
...
LOGGER = logging.getLogger("clearbox.node.usb")
...
def adb_push_file(serial: str, local_path: str, remote_path: str) -> bool:
    ...
    Args:
        ...
        remote_path: Target path on device (e.g., /sdcard/Download/ClearboxAI/)
