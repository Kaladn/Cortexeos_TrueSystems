"""End-to-end smoke test for the Clearbox bridge and control deck API."""
...
BRIDGE_SCRIPT = ROOT / "bridges" / "clearbox_bridge_server.py"
CONFIG_PATH = ROOT / "clearbox.config.json"
HOST = "127.0.0.1"
PORT = 5050
...
def run_smoke_test() -> None:
    ...
    try:
        ...
        map_payload = _request_json(
            "POST",
            "/api/map",
            {"text": "clearbox ai smoke test verifies control deck"},
        )
        ...
        sample_file = (ROOT / "samples" / "clearbox_ai_section1" / "index.html").resolve()
