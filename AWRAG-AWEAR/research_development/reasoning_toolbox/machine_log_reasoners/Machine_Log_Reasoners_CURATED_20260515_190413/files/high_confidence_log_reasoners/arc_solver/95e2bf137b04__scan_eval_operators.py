"""
Test the expanded 6-1-6 operator system (11 operators) on ARC evaluation set.
"""
import json
import numpy as np
...
print("=" * 70)
print("FULL EVALUATION SET OPERATOR SCAN (11 OPERATORS)")
print("=" * 70)

solved_tasks = []
operator_counts = {}

for task_id in eval_challenges.keys():
...
print(f"\n✅ SOLVED: {len(solved_tasks)}/400 evaluation tasks\n")
