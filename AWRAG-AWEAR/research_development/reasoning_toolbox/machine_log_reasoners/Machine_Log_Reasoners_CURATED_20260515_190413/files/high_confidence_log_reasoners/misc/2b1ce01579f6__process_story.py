#!/usr/bin/env python3
"""
Process "The Basement" story through the contextual lattice generator.
...
# Add phase_two directory to path to import modules
sys.path.append('/home/ubuntu/phase_two')

from context_window_parser import ContextWindowParser
from directional_semantic_integration import DirectionalSemanticResonance, ContextCloudManager
