...
imported into AWEAR. The safe path is:

```text
old reasoning shapes teach
new AWEAR helpers implement
```
...
SecureCore as product dependencies. Translate specific ideas into AWEAR-native
...
```text
research_development/reasoning_toolbox
```
...
securecore_agent_references      5 files, about 18 KB
...
```text
research_development/reasoning_toolbox/README.md
research_development/reasoning_toolbox/reference_requests_do_not_run/request.md
research_development/reasoning_toolbox/imported_reference_code/05_reaper_multi_anchor_scoring/reaper_cognitive_engine.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/clearbox/6a8eeff1be1a__6a8eeff1be1a__engine.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/clearbox/f8e2cd242ef4__f8e2cd242ef4__reasoning_service.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/cortexos/27ef6d1d1bb5__27ef6d1d1bb5__topk_sparse_resonance.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/cortexos/049d01a29e0c__049d01a29e0c__trust_filter.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/cortexos/c0fbc283f01f__c0fbc283f01f__knowledge_reinforcer.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/arc_solver/8de1ac8e8cf0__8de1ac8e8cf0__arc_core.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/arc_solver/f922242d1192__f922242d1192__composition_engine.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/compucog/84da29e6e0eb__84da29e6e0eb__binary_log.functions.py
research_development/reasoning_toolbox/imported_reference_code/extracted_function_fallbacks/compucog/e8df3326fab3__e8df3326fab3__recognition_field.functions.py
research_development/reasoning_toolbox/whole_pc_selected_references/phone_download_mtp/swarm_resonance.py
research_development/reasoning_toolbox/whole_pc_selected_references/phone_download_mtp/resonance_field.py
research_development/reasoning_toolbox/whole_pc_selected_references/phone_download_mtp/resonance_monitor.py
research_development/reasoning_toolbox/securecore_agent_references/runner/securecore_agent_runner.py
```
...
Do not import them from src/awrag.
Do not execute request-note folders or recovered agent code as product runtime.
Promote ideas only through normal AWEAR code, tests, docs, and receipts.
```
...
```text
securecore_agent_references/runner/securecore_agent_runner.py
securecore_agent_references/README.md
```
...
SecureCore recovered agent runner
...
would bypass AWEAR evidence mechanics
...
extract shape
rewrite tiny AWEAR-native helpers
test against AWEAR packet/trace data
...
```text
AWEAR rename / compatibility committed separately.
