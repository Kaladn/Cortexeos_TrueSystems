...
from awrag.engine.base import safe_id, utc_now, with_protected_notice, write_json


RUN_SCHEMA = "awrag_pressure_coordination_audit_run@0"
REAL_SCHEMA = "awrag_pressure_coordination_real_system_trace@0"
REAPER_SCHEMA = "awrag_pressure_coordination_reaper_mutation_trace@0"
COMBINED_SCHEMA = "awrag_pressure_coordination_combined_strength_trace@0"
...
def run_pressure_coordination_audit(*, trace_path: str | Path, out_dir: str | Path) -> dict[str, Any]:
    ...
    no_mutation = {
        "schema": "awrag_pressure_coordination_no_mutation_receipt@0",
        "created_at": utc_now(),
