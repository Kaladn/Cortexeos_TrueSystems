...
COMMANDS: tuple[OperatorCommand, ...] = (
    OperatorCommand(
        ...
        cli_template="python -m awear.cli intake --runtime-root <runtime> --dataset-id <dataset> --source <source-folder> --window 6 --workers auto --ram-budget-gb 8 --reserve-ram-fraction 0.15",
        touches=(
    ...
    OperatorCommand(
        ...
        cli_template='python -m awear.cli query --runtime-root <runtime> --dataset-id <dataset> --question "<question>" --top-k 5',
    ...
    OperatorCommand(
        ...
        cli_template="python -m awear.cli batch --runtime-root <runtime> --dataset-id <dataset> --questions <questions.txt> --top-k 10 --workers 4",
    ...
    OperatorCommand(
        ...
        cli_template='python -m awear.cli count-walk-speech --runtime-root <runtime> --dataset-id <dataset> --question "<question>" --out <speech-folder>',
    ...
    OperatorCommand(
        ...
        cli_template="python -m awear.cli status --runtime-root <runtime> --dataset-id <dataset>",
    ...
    OperatorCommand(
        ...
        cli_template="python -m awear.cli laptop-temp-intake --source <file-or-folder> --state-root <generated-state-root> --run-id <run-id> --chunk-mb 25 --max-chunks 3 --workers 4 --reserve-ram-fraction 0.15 --ram-budget-gb 8",
