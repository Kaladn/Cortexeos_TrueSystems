...
from truevision_intake.document_state import record_document_state_movie
...
def load_font(name: str, size: int) -> ImageFont.ImageFont:
    bold = "bold" in name.lower() or name.lower().endswith("bd.ttf") or name.lower().endswith("b.ttf")
    candidates = (
        Path("/usr/share/fonts/noto/NotoSans-Bold.ttf") if bold else Path("/usr/share/fonts/noto/NotoSans-Regular.ttf"),
        Path("/usr/share/fonts/TTF/DejaVuSans-Bold.ttf") if bold else Path("/usr/share/fonts/TTF/DejaVuSans.ttf"),
        Path("/usr/share/fonts/gnu-free/FreeSansBold.ttf") if bold else Path("/usr/share/fonts/gnu-free/FreeSans.ttf"),
    )
