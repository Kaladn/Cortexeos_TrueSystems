...
from truespeech_runtime.lyrics import align_lyrics_to_speech_segments
from truespeech_runtime.speech import detect_speech_segments_from_replayable_state
