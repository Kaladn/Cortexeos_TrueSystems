...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--audio", default="inputs/phoenix_flats_audio.wav")
    parser.add_argument("--stems", default="inputs/phoenix_flats_stems.zip")
    parser.add_argument(
        "--storyboard-sheet",
        default="inputs/phoenix_flats_storyboard.png",
    )
