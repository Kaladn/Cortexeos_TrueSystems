...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--audio", default="inputs/cleveland_audio.wav")
    parser.add_argument("--stems", default="inputs/cleveland_stems.zip")
    parser.add_argument("--skyline", default="inputs/cleveland_skyline.png")
    parser.add_argument("--proof-a", default="inputs/cleveland_proof_a.png")
    parser.add_argument("--proof-b", default="inputs/cleveland_proof_b.png")
