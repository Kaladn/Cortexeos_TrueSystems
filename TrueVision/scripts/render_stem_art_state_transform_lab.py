...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--audio", default="inputs/stem_art_audio.wav")
    parser.add_argument("--stems", default="inputs/stem_art_stems.zip")
    parser.add_argument("--skyline", default="inputs/stem_art_skyline.png")
    parser.add_argument("--proof-a", default="inputs/stem_art_proof_a.png")
    parser.add_argument("--proof-b", default="inputs/stem_art_proof_b.png")
