...
**Architecture:** Stabilize in place without moving imports. Add docs that define the TrueMem/SC/TV boundaries and a lightweight preflight script that reports local prerequisites and repo health without installing or mutating anything.
...
- Create: `docs/TRUEVISION_TRUECORE_SAFETY_BOUNDARY.md`
