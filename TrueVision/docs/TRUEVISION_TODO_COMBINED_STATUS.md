...
- Local product map, active tool surface, parked experiment map, TrueMem/SC boundary contracts, and preflight script exist.
...
- open TrueCore workspace first
- inventory SC/TrueMem/TV workbench
- lock cross-system harness shape
- prove TrueMem, SC, and TV health checks separately
