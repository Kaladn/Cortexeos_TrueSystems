#!/usr/bin/env python3
"""Route one TrueVision worker receipt into a TrueCore-style decision packet."""
...
def route_receipt(receipt_path: Path) -> dict[str, Any]:
    ...
    decision = {
        "schema_version": "truecore_truevision_worker_route_decision_v1",
        "agent_id": AGENT_ID,
        ...
        "context": {
            ...
            "truecore_boundary": "agent routes and reasons only",
