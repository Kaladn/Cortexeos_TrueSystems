#!/usr/bin/env python3
"""Validate a TrueVision-to-TrueCore agent handoff package."""
...
def build_gate_report(handoff_root: Path) -> dict[str, Any]:
    ...
    catalog_results = [
        ...
        validate_catalog(agents_root / "catalog" / "truecore_agents.csv"),
    ]
    passed = (
    ...
    report = {
        "schema_version": "truecore_truevision_zero_tolerance_gate_report_v1",
        "agent_id": AGENT_ID,
        ...
        "recommended_action": "truecore_review" if passed else "reject_until_fixed",
        "context": {
